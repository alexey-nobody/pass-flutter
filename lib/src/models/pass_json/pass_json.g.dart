...
PassJson _$PassJsonFromJson(Map<String, dynamic> json) {
  return PassJson(
    ...
    labelColor: PassJson._convertToColor(json['labelColor'] as String),
    backgroundColor:
        PassJson._convertToColor(json['backgroundColor'] as String),
    foregroundColor:
        PassJson._convertToColor(json['foregroundColor'] as String),
...
Map<String, dynamic> _$PassJsonToJson(PassJson instance) => <String, dynamic>{
      ...
      'backgroundColor': PassJson._convertFromColor(instance.backgroundColor),
      'foregroundColor': PassJson._convertFromColor(instance.foregroundColor),
      'labelColor': PassJson._convertFromColor(instance.labelColor),
